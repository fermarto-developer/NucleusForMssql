...
namespace Nucleus.EntityFramework
{
    public class NucleusDbContext : IdentityDbContext<User, Role, Guid, UserClaim, UserRole, UserLogin, RoleClaim, UserToken>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity((Action<EntityTypeBuilder<Role>>)(b =>
            {
                b.ToTable("Role");
                b.HasMany(p => p.UserRoles)
                    .WithOne(r => r.Role).HasForeignKey(f => f.RoleId);
                b.HasData(SeedData.BuildApplicationRoles());
            }));
            ...
            modelBuilder.Entity((Action<EntityTypeBuilder<User>>)(b => 
            {
                ...
                b.HasMany(r => r.UserRoles)
                    .WithOne(ur => ur.User).HasForeignKey(p => p.UserId);
            }));
